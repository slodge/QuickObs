...
namespace QuickObs.Core.ViewModels
{
    ...
    public class SecondViewModel
        : MvxViewModel
    {
        private static PObservableCollection<string> _StaticThings = new PObservableCollection<string>()
            {
                "One",
                "TWo"
            };

        private PObservableCollection<string> _things = _StaticThings;
        public PObservableCollection<string> Things
        {
            get { return _things; }
        ...
        public IMvxCommand Add
        {
            get
            {
                return new MvxCommand(() => _StaticThings.Insert(0, "New" + ((IList)_StaticThings).Count.ToString()));
            }
        }
    }

    public class PObservableCollection<T>
        : INotifyCollectionChanged, IList<T>, IList
    {
